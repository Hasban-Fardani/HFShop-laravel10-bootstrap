    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePromo" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="collapse-inner rounded bg-white py-2">
                        {{-- <h6 class="collapse-header">Category Management:</h6> --}}
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="collapse-inner rounded bg-white py-2">
                        ...
                        <a class="collapse-item" href="{{ route('admin.orders.index') }}">Order List</a>
                        <a class="collapse-item" href="{{ route('admin.orders.index', ['success' => true]) }}">Order
                            Success</a>
            ...
            <div class="topbar-divider d-none d-sm-block"></div> --}}
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="d-none d-lg-inline small mr-2 text-black">{{ auth()->user()->name }}</span>
                                @include('icons.user')
                            </a>
